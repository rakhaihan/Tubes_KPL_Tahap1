...
namespace Tubes_Console
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine($"Terjadi kesalahan di program utama: {ex.Message}");
            }
        }
        ...
        static void TambahSiswa(SiswaService siswaService)
        {
            ...
            {
                Console.WriteLine($"Terjadi kesalahan saat menambahkan siswa: {ex.Message}");
            }
        }
        ...
        static void TampilkanSemuaSiswa(SiswaService siswaService)
        {
            ...
            {
                Console.WriteLine($"Terjadi kesalahan saat menampilkan siswa: {ex.Message}");
            }
        }
        ...
        static void TambahPelanggaran(SiswaService siswaService, PelanggaranService pelanggaranService, AppConfig config)
        {
            ...
            {
                Console.WriteLine($"Terjadi kesalahan saat menambahkan pelanggaran: {ex.Message}");
            }
        }
        ...
        static void LihatPelanggaranSiswa(SiswaService siswaService)
        {
            ...
            {
                Console.WriteLine($"Terjadi kesalahan saat melihat pelanggaran siswa: {ex.Message}");
            }
        }
        ...
        static void UbahStatusPelanggaran(SiswaService siswaService, PelanggaranService pelanggaranService)
        {
            ...
            {
                Console.WriteLine($"Terjadi kesalahan saat mengubah status pelanggaran: {ex.Message}");
            }
        }
    }
}
